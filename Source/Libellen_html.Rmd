...
```{r figuurBezoekenlibellen, message= FALSE, warning= FALSE, fig.height= 7, fig.width= 6.5,  fig.cap = "Overzicht tijdstippen waarop tellingen werden uitgevoerd in 2017" }
